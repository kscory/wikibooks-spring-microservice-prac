package kscory.com.gamification.repository;
...
public interface ScoreCardRepository extends CrudRepository<ScoreCard, Long> {
     ...
     */
    @Query("SELECT NEW kscory.com.gamification.domain.LeaderBoardRow(s.userId, SUM(s.score)) " +
            "FROM kscory.com.gamification.domain.ScoreCard s " +
